...
const MOODS: Record<WeatherCondition, MoodBase> = {
  clear: { ambientTintHex: 0x223047, skyTintHex: 0x8fa3c0, fogDensityMultiplier: 0.7, sunIntensityMultiplier: 1.0, particle: "none", lightning: false },
  cloudy: { ambientTintHex: 0x334059, skyTintHex: 0x8494ab, fogDensityMultiplier: 1.15, sunIntensityMultiplier: 0.72, particle: "none", lightning: false },
  fog: { ambientTintHex: 0x3a4351, skyTintHex: 0x9099a4, fogDensityMultiplier: 2.2, sunIntensityMultiplier: 0.5, particle: "none", lightning: false },
  rain: { ambientTintHex: 0x243040, skyTintHex: 0x5d6a7a, fogDensityMultiplier: 1.5, sunIntensityMultiplier: 0.5, particle: "rain", lightning: false },
  snow: { ambientTintHex: 0x414a5a, skyTintHex: 0x949ba7, fogDensityMultiplier: 1.35, sunIntensityMultiplier: 0.55, particle: "snow", lightning: false },
  storm: { ambientTintHex: 0x1a2029, skyTintHex: 0x3d4552, fogDensityMultiplier: 1.9, sunIntensityMultiplier: 0.3, particle: "rain", lightning: true },
};
